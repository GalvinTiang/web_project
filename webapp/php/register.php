...
if (isset($_POST['submit'])) {
  ...
  $phone =$_POST["phone"];
  echo $sqlregister = "INSERT INTO `tbl_users`(`user_name`, `user_email`, `user_password`, `user_phone`) VALUES ('$name','$email','$password','$phone')";
  try {
      ...
      <div class="w3-row w3-card">
        ...
        <div class="w3-center w3-container">
          ...
          <form name="registerForm" class=""  action="register.php" method="post">
            ...
            <p>
              <button class="w3-btn w3-round w3-black w3-block" name="submit">Register</button>
            </p>
